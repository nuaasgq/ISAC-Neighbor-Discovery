...
- Main figures are selected in `../../06_analysis/manuscript_figure_selection.md`; all figure paths referenced by `main.tex` and `supplement.tex` have been checked on disk.
...
- A fresh LaTeX figure audit checked 51 referenced PNG files for presence and approximate 4:3 aspect compliance.

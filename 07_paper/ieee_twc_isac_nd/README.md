...
- Focused learned-component ablation evidence is recorded in `../../06_analysis/phase10_learned_component_ablation_report_20260707.md`, with tables under `../../06_analysis/paper_tables/marl/p10_learned_component_ablation_b10_3ep/` and figures under `../../06_analysis/figures/marl/p10_learned_component_ablation_b10_3ep/`.

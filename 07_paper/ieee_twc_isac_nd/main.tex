...
\begin{equation}
  ...
  \label{eq:beam_score}
\end{equation}
where $q_i^t(b)$ is the ISAC occupancy belief, $d_i^t(b)$ encourages beam diversity, $u_i^t$ is a local degree-need term, and $a_i^t(b)$ is a staleness term.
...
This form makes ISAC feedback useful without permanently pruning beams that may have been affected by sensing errors.

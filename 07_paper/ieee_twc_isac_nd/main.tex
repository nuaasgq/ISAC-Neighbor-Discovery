...
\end{equation}
where $\hat{\mathcal{G}}^T=(\mathcal{V},\hat{\mathcal{E}}^T)$, $\lambda_2(\cdot)$ is the algebraic connectivity of the discovered graph, $\rho_{\mathrm{empty}}^T$ is the empty-scan ratio, and $C^T$ is the collision count or its normalized variant.
...
The multi-seed transfer results show that the ISAC-assisted improved policy can transfer from $N=10$ and 10-degree beams to larger swarms without fine-tuning in the tested operating regimes.
...
The multi-seed transfer check confirms this trend at $N=100$, as summarized in Table~\ref{tab:n100_transfer}.
...
\begin{table}[!t]
  ...
  \begin{tabular}{lccccc}
    \toprule
    Scale & Beam & Disc. & Empty & $\lambda_2$ & Delay \\
    \midrule
    Density & 5$^\circ$  & 0.0814 & 0.8161 & 0.8430  & 576.64 \\
    Density & 10$^\circ$ & 0.3655 & 0.4986 & 12.9222 & 477.99 \\
    Density & 15$^\circ$ & 0.5440 & 0.3293 & 26.8413 & 406.74 \\
    Density & 30$^\circ$ & 0.4568 & 0.1815 & 25.9812 & 438.66 \\
    Fixed   & 5$^\circ$  & 0.0822 & 0.8152 & 1.0800  & 576.21 \\
    Fixed   & 10$^\circ$ & 0.3615 & 0.5021 & 11.0417 & 479.00 \\
    Fixed   & 15$^\circ$ & 0.5352 & 0.3315 & 23.2957 & 410.82 \\
    Fixed   & 30$^\circ$ & 0.4487 & 0.1816 & 25.0550 & 442.39 \\
    \bottomrule
  \end{tabular}
\end{table}
...
Sixth, the efficiency metrics are scan-action and collision normalized; a delay-power product comparison would require an explicit radio-state energy model.

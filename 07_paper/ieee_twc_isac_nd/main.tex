...
Finally, the proposed ISAC-assisted policy creates more collision attempts than the no-ISAC baseline in dense finite-horizon tests; collision-penalized discovery and energy-normalized efficiency should be reported alongside raw discovery rate before a submission-ready version.

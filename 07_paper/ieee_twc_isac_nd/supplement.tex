...
However, the collision-penalized panel exposes a MAC-layer boundary: at B=15 the one-slot delayed variant has collision-penalized discovery 0.2207 versus 0.2042 for the proposed low-latency variant, so collision-aware role control remains open.

...
\begin{table*}[!t]
  ...
  \begin{tabular}{p{0.17\textwidth}p{0.12\textwidth}p{0.38\textwidth}p{0.16\textwidth}}
    ...
    Small-to-large transfer & Bounded & Training at $N=10$, 10 deg; N=100 zero-shot tables and figures. & Main training is shared-parameter policy optimization. \\
...
It confirms that the mobility-boundary interpretation is not caused by omitting the SkyOrbs-like or vanilla learned no-ISAC baseline.

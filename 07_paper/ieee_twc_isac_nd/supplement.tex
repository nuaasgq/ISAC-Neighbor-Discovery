...
\begin{figure*}[!t]
  \centering
  \includegraphics[width=0.48\textwidth]{../../06_analysis/paper_figures/structured_marl_probe/marl_bc_loss_curve.png}
  \hfill
  \includegraphics[width=0.48\textwidth]{../../06_analysis/paper_figures/structured_marl_probe/marl_reward_curve.png}
  \caption{Structured neural MARL probe training traces. Left: behavior-cloning loss. Right: mean reward during teacher-forced training episodes.}

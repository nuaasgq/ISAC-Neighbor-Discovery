...
A no-ISAC-label follow-up is treated only as a label-sensitivity sanity check because the evaluation environment still exposes ISAC candidate observations; it is therefore not used as a clean no-ISAC neural baseline.

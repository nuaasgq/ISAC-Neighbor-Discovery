...
\begin{table*}[!t]
  \centering
  \caption{Representative Paired Treatment-Control Deltas from Identical Scenario Seeds}
  \label{tab:supp_paired_delta}
  \scriptsize
  \setlength{\tabcolsep}{3pt}
  \begin{tabular}{p{0.36\textwidth}ccc}
    \toprule
    Scenario and comparison & $\Delta$ discovery (95\% bootstrap CI) & $\Delta$ empty or efficiency & $\Delta\lambda_2$ \\
    \midrule

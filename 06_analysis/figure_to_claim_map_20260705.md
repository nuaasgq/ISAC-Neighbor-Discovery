...
| Round12 radio-state accounting | `round12_collision_aware_probe_v2/round12_discoveries_per_joule.png`, `round12_energy_per_discovery.png` | Does the collision-aware role-control probe also improve assumed energy accounting? Yes, under stated default radio-state powers, while not claiming platform-calibrated optimality. |

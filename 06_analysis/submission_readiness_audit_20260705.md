...
2. Collision-aware efficiency is partly addressed by the round13 role-control probe, assumed radio-state accounting, and post-hoc power-profile sensitivity; dense 15/30-degree cases still need a full MAC and platform-calibrated energy model.

...
- Training convergence is covered by `06_analysis/paper_figures/training_round2_candidate/train_reward_curve.png`
...
| Training convergence | `06_analysis/paper_figures/training_round2_candidate/train_reward_curve.png` | Satisfies the required reward/score convergence evidence. |
...
| Mechanism ablation | `06_analysis/paper_figures/round4_delay_ablation/ablation_discovery_n100_b10.png` | Shows candidate-set refinement is the dominant contributor and includes the one-slot-delay boundary. |

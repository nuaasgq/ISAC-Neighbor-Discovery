...
- Status counts: PASS=12, CAUTION=5, OPEN=1.
...
- Artifact manifest: 124 artifacts, 0 missing.
...
| R14 | Figure and artifact integrity | PASS | artifact_hash | Artifact manifest reports 124 artifacts and 0 missing paths; training manifest lists 19 training/resource figures. |

...
| Collision-aware MAC refinement | Covered as mechanism probe | `06_analysis/paper_tables/round12_collision_aware_probe_v2/`; `06_analysis/paper_figures/round12_collision_aware_probe_v2/`. | Shows the B=15 collision-penalized boundary can be mitigated by local role control; not a full energy-aware MAC solution. |

...
| Ten-seed main-table stability at N=100/B=10 | Covered | `06_analysis/paper_tables/round14_main_table_10seed_n100_b10/`; `06_analysis/paper_figures/round14_main_table_10seed_n100_b10/`. | Use as the main B=10 baseline stability evidence; it does not cover B=15 or replace collision/energy probes. |
| Focused paired-seed stability campaign | Covered | `06_analysis/paper_tables/round11_paired_seed_campaign_main/`; `06_analysis/paper_figures/round11_paired_seed_campaign_main/`. | Five paired seeds at N=100, B=10/15, Gauss-Markov, 600 slots; use as B=10/B=15 mechanism evidence and B=15 stability support. |
...
| Does the main N=100/B=10 baseline table survive ten paired seeds? | `06_analysis/paper_figures/round14_main_table_10seed_n100_b10/round14_main_table_discovery_lambda2.png`. |

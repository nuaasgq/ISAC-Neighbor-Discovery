...
- Do not claim a head-to-head comparison with complete SkyOrbs; the current baseline is SkyOrbs-like skip-scan under the same simulator information boundary, and the supplement/scope appendix explicitly mark it as non-reproduction.
...
- Do not claim final collision-optimal scheduling or platform-calibrated energy optimality; round13 is a mechanism probe with assumed radio-state accounting.

## Best Next Experiment

The most defensible next experiment is not a broad Cartesian sweep.
The 10-seed main-table check and the 10-seed collision/energy probe are now complete; next prioritize either radio-state accounting sensitivity under stated default powers, a platform-calibrated power study, or a calibrated PHY-to-ISAC sensing-parameter mapping.

...
DEFAULT_DIRECT_ARTIFACTS = [
    ...
    Path("06_analysis/scripts/build_phase10_beamwidth_boundary_audit.py"),
    ...
    Path("06_analysis/scripts/build_phase10_learned_claim_boundary_audit.py"),
    ...
    Path("06_analysis/phase10_beamwidth_boundary_audit_20260707.md"),
    ...
    Path("06_analysis/phase10_learned_claim_boundary_audit_20260707.md"),
    ...
    Path("06_analysis/paper_tables/marl/p10_beamwidth_boundary_audit/beamwidth_boundary_checks.csv"),
    Path("06_analysis/paper_tables/marl/p10_beamwidth_boundary_audit/manifest.json"),
    Path("06_analysis/paper_tables/marl/p10_beamwidth_boundary_audit/README.md"),
    ...
    Path("06_analysis/paper_tables/marl/p10_learned_claim_boundary_audit/learned_claim_checks.csv"),
    Path("06_analysis/paper_tables/marl/p10_learned_claim_boundary_audit/paired_episode_claim_checks.csv"),
    Path("06_analysis/paper_tables/marl/p10_learned_claim_boundary_audit/manifest.json"),
    Path("06_analysis/paper_tables/marl/p10_learned_claim_boundary_audit/README.md"),

...
PLOT_METRICS = [
    ...
    ("discovery_per_scan_action", "Discoveries per scan action", "higher"),
    ("collision_penalized_discovery_rate", "Collision-penalized discovery rate", "higher"),
    ("collision_normalized_efficiency", "Collision-normalized efficiency", "higher"),
]

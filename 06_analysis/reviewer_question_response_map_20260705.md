...
| How is the SkyOrbs-like baseline scoped? | The paper does not claim a strict head-to-head win over complete SkyOrbs. It includes a SkyOrbs-like 3-D skip-scan baseline under the same information boundary. | `main.tex` Baselines and Limitations; `round8` and `round9` full-baseline figures. | Complete SkyOrbs reproduction is future work. |

...
| Energy efficiency is incomplete. | Recent UAV ND work jointly optimizes delay and power. | Round12 implements assumed radio-state accounting and improves discoveries per joule under the default powers. | Treat energy metrics as diagnostic accounting; keep platform-calibrated delay-power optimization as future work. |
